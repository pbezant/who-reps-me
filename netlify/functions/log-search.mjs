// Logs every search a visitor runs — the raw address/ZIP/place text they typed, plus whatever
// geocode() resolved it to (state/county/place/districts) — so the searches themselves can be
// reviewed later (see search-log.mjs). Deliberately logs the raw query text: unlike the bug-report
